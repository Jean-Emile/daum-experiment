...
class ComputerDataProviderActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { ComputerDataProviderFactory.createComponentActor() } }
