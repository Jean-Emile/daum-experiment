...
class FakeTrustServerActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { FakeTrustServerFactory.createComponentActor() } }
