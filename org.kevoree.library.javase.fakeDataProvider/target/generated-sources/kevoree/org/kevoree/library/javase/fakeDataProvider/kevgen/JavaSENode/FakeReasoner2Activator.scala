...
class FakeReasoner2Activator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { FakeReasoner2Factory.createComponentActor() } }
