...
class ClientHWActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { ClientHWFactory.createComponentActor() } }
