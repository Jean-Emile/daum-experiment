...
class TrustManagerMoverActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { TrustManagerMoverFactory.createComponentActor() } }
