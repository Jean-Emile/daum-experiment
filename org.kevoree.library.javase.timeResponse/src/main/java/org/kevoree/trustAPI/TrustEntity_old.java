...
@Library(name = "Trust")
@ComponentType
public class TrustEntity_old extends AbstractComponentType implements ITrustEntity {
    ...
    private void initializeTrustRelationships()
    {
        ...
        AbstractMetric m = null; //= getPortByName("instance", ITrustMetric.class).getInstance(this);
    ...
    @Override
    @Port(name="factorManagement", method="onNewTrustValueAvailable")
    public void onNewTrustValueAvailable(String context, String metricSender, String idTrustee) {
